...
namespace AntEngine.Entities.Colonies
{
    ...
    public class Colony<E> : LivingEntity where E : LivingEntity
    {
        ...
        /// </summary>
        public Func<string, Transform, World, Colony<E>, E> SpawnMethod { get; set; }
        ...
        public virtual void Spawn(int count = 1)
        {
            for (int i = 0; i < count && HasEnoughResources(); i++)
            {
                ...
                E pop = SpawnMethod("", new Transform(SpawnPosition, 0, Vector2.One), World, this);
                if (pop != null) _population.Add(pop);
            }
        }
