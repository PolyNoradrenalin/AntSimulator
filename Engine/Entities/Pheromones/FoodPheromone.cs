...
namespace AntEngine.Entities.Pheromones
{
    ...
    public class FoodPheromone : Pheromone
    {
        ...
        public FoodPheromone(World world, int maxTimeSpan) : this(DefaultPheromoneName, new Transform(), world, maxTimeSpan)
        {
        }

        public FoodPheromone(string name, Transform transform, World world, int maxTimeSpan) : base(name, transform, world, maxTimeSpan)
        {
        }
    }
}