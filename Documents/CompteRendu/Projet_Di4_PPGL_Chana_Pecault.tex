...
\label{sec:biblio}
\bibitem{ref1} Vidéos intéressante sur la simulation d'une colonie : \\ \url{https://www.youtube.com/watch?v=X-iSQQgOd1A}
\bibitem{ref2} Vidéos style documentaire du BBC : \\ \url{https://www.youtube.com/watch?v=qu0HN9rYtIw}
\bibitem{ref3} Vidéos intéressante : \\ \url{https://www.youtube.com/watch?v=VLBDVXLiWxQ}
\bibitem{ref4} Article sur une simulation qui a été faite : \\ \url{https://softologyblog.wordpress.com/2020/03/21/ant-colony-simulations/}
\bibitem{ref5} Article wikipedia sur les algorithmes de colonies de fourmis : \\ \url{https://fr.wikipedia.org/wiki/Algorithme_de_colonies_de_fourmis}
\end{thebibliography}
...
Les commandes suivantes nécessitent d'être dans le répertoire du projet (au même niveau que le fichier .sln du module qu'on veut exécuter).
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{diagramme_moteur.png}
    \caption{Diagramme de classe simplifié du moteur.}
    \label{fig:diagramme_moteur}
\end{figure}


\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{diagramme_application.png}
    \caption{Diagramme de classe simplifié de l'application.}
    \label{fig:diagramme_application}
\end{figure}
...
\resume{Au sein de ce projet de semestre de programmation et de génie logiciel, nous avons réalisé une simulation de colonie de fourmis. Nous avons donc eu à apprendre comment les fourmis font pour découvrir et intéragir avec leur environnement. Nous avons également pu mettre en pratique les conseils et normes de qualité logiciel qui ont été apprise en cours. Au delà des aspects de qualité logiciel, nous avons appris comment structurer un projet en C\# et comment mieux utiliser les outils de communication sur GitHub.}

\motcles{Fourmi, Carte de perception, Collision, Phéromone, Optimisation, C\#, .NET, MonoGame}

\abstract{During this semester's projet in programming and software engineering, we created an ant colony simulator. To accomplish this we had to learn about how ants discover and interact with their environnements. We were also able to put into practise the standards of software engineering taught in class. Beyond the software engineering aspects, we learned how to structure a C\# project and how to communicate better using GitHub.}

\keywords{Ant, Perception map, Collision, Pheromone, Optimization, C\#, .NET, MonoGame}
